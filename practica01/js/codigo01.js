...
function funcionSaludar() {
  ...
  function funcionMultiplosde5() {
    ...
    let tamaño32 = multiplos.length;
    let texto32 = "<ul>";

    for (let f = 0; f < multiplos.length; f++) {
...
------------------------------------------------------------------------------------------------*/
  function funcionImparesaleatoriodel10al100() {
    ...
    for (let k = 0; k < limites01; k++) {
      var aleatorio = Math.floor(Math.random() * 100) + 10;
      aleatorios[k] = aleatorio;
    }
    let tamaño35 = aleatorios.length;
    let texto35 = "<ul>";

    for (let m = 0; m < aleatorios.length; m++) {
...
----------------------------------------------------------------------------------------------------------------------------*/
  function funcionImparesmultiplosde3() {
    ...
    for (let ld = 0; ld < limmultiplo3; ld++) {
      if (ld % 3 == 0) {
        multiplos3[ld] = ld;
      } else {
        multiplos3[ld] = " ";
    ...
    let tamaño332 = multiplos3.length;
    let texto332 = "<ul>";

    for (let ln = 0; ln < multiplos3.length; ln++) {
